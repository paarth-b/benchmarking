...
def main():
    ...
    config = {
        "cath": {
            ...
            "output": "results/tmalign_similarities.parquet"
        },
        "scope40": {
            "fasta": "data/fasta/scope40-1000.fa",
            "pdb_dir": "data/scope40pdb",
            "output": "results/scope40_tmalign_similarities.parquet"
        }
    }[args.dataset]
    ...
    df.to_parquet(config['output'], compression='snappy', index=False)
